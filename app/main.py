...
from app.api.routers.v1.health import router as health
...
app = FastAPI(
    ...
    description="A service that transliterates text between scripts",
    version="0.1.0",
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://127.0.0.1:3000", "http://localhost:3000"], # for now locally
